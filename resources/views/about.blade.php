...
@section('content')
        ...
        <div class="row">
            <div class="col-md bg-info rounded-3 m-2">
                <div class="image-wrapper" style="margin: 0 auto;">
                    <img src="./images/matko.jpg" alt="Matko" class="rounded mx-auto d-block"
                ...
                <div class="about-text text-center">
                    <br>
                    <p>Student sam treće godine računarstva na Fakultetu strojarstva, računarstva i elektrotehnike u
                        Mostaru.
            ...
            <div class="col-md bg-info rounded-3 m-2">
                <div class="image-wrapper">
                    <img src="./images/mijo.jpg" alt="Mijo" class="rounded mx-auto d-block"
                         style="clip-path: circle(); ">
                </div>
                <div class="about text-center">
        ...
        <div class="row">
            <div class="col-md bg-info rounded-3 m-2 p-2">
                ...
                <p class="about-text text-center">
                    ...
                    kao i tehnologija koje se za isto koriste, također smatramo da jako mali broj dentalnih ordinacija
                    posjeduje sustav za online narudžbe i da bi takvo nešto bilo od velike koristi.
                    Više o projektu možete pronaći u <a class="vizija"
                                                        href="https://drive.google.com/file/d/1zN2t6yMwZ3X0w74FgyLLbPZP4WnMinMt/view?usp=sharing">Viziji</a>
                </p>
            </div>
            <div class="col-md bg-info rounded-3 m-2 p-2">
                <h5 class="text-center">Tehnologije koje cemo koristiti?</h5>
                <p class="about-text text-center">
                    Najvjerojatnije ce to biti Laravel <span><img src="./images/laravel.png" alt="Laravel"
                                                                  class="img-responsive"> i Vue.js <img
                            src="./images/vueJs.png" alt="Vue.js"></span>
                </p>
            </div>
        </div>
    </div>
    <br> <br>
    <div class="container">
        <h1 class="text-center">Use case diagram</h1>
        <p class="about-text text-center">
            <br><br>
            <span> <img src="./images/RWA.vpd.png" alt="Vue.js"></span>
        </p>
    </div>
