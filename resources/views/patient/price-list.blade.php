    ...
    <div class="container">
        <table class="table table-info table-striped mt-5">
            ...
            <tr>
                ...
                <th scope="col">Duration                                             <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18"
            ...
            @foreach($services as $service)
                <tr>
                    ...
                    <td class="py-2">{{$service->price}}<i>$</i></td>
                    <td class="py-2">{{$service->duration}} <i>min</i></td>
                </tr>
            @endforeach
            </tbody>
        </table>
