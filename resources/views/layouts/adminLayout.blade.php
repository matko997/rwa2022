                ...
                <ul class="nav nav-pills flex-column mb-sm-auto mb-0 align-items-center align-items-sm-start" id="menu">
                    ...
                    <li>
                        ...
                        <ul class="collapse show nav flex-column ms-1" id="submenu1" data-bs-parent="#menu">
                            <li class="w-100">
                                <a href="{{route('admin.doctor.index')}}" class="nav-link px-0 text-white"> <span class="d-none d-sm-inline">Doctors</span>  </a>
                            </li>
                            <li>
                                <a href="{{route('admin.patient.index')}}" class="nav-link px-0 text-white"> <span class="d-none d-sm-inline">Patients</span>  </a>
                            </li>
                        </ul>
                    </li>
                    <li>
