        ...
        <div class="row">
            <div class="col-md mt-5">
                <div class="card text-dark bg-light mb-3">
                    <h2 class="card-title mt-2 m-lg-2">Sign up</h2>
                    <div class="card-body ">
                        <form action="{{route('signup')}}" class="form-control mx-auto border-0 " method="POST">
                            ...
                            <div class="form-check">
                                <input class="form-check-input" type="radio" name="gender" id="radioGender1"
                            ...
                            <div class="form-check">
                                <input class="form-check-input" type="radio" name="gender" id="radioGender2"
